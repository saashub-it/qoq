# @saashub/qoq-eslint-v9-ts-jest-rtl

![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/saashub-it/qoq/main.yml) ![NPM Version](https://img.shields.io/npm/v/%40saashub%2Fqoq-eslint-v9-ts-jest-rtl)
![NPM Type Definitions](https://img.shields.io/npm/types/%40saashub%2Fqoq-eslint-v9-ts-jest-rtl) ![NPM Unpacked Size](https://img.shields.io/npm/unpacked-size/%40saashub%2Fqoq-eslint-v9-ts-jest-rtl) ![NPM License](https://img.shields.io/npm/l/%40saashub%2Fqoq-eslint-v9-ts-jest-rtl)
...
## Install
    ...
    npm install @saashub/qoq-eslint-v9-ts-jest-rtl
...
```js
const jsBaseConfig = require("@saashub/qoq-eslint-v9-ts-jest-rtl");
...
```js
import jsBaseConfig from '@saashub/qoq-eslint-v9-ts-jest-rtl';
...
To preview all rules defined by this config simply run:
    ...
    npx -y @saashub/qoq-eslint-v9-ts-jest-rtl
